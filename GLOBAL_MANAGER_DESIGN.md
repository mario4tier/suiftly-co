...
- **Periodic** - Runs every 5 minutes via systemd timer
...
**Implementation:** TypeScript with Node.js 22 LTS, deployed via systemd timer for maximum reliability.
...
# View next run time
systemctl list-timers suiftly-global-manager.timer
