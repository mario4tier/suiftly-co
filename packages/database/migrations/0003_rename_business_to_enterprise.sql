...
-- Rename ConfigGlobal keys from _bus suffix to _ent suffix
UPDATE "ConfigGlobal" SET "key" = 'fbw_ent' WHERE "key" = 'fbw_bus';
UPDATE "ConfigGlobal" SET "key" = 'fsubs_usd_ent' WHERE "key" = 'fsubs_usd_bus';
UPDATE "ConfigGlobal" SET "key" = 'bglim_ent' WHERE "key" = 'bglim_bus';
