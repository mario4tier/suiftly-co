    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">Guaranteed Bandwidth</h3>
          <Popover>
            ...
            <PopoverContent className="w-80">
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Bandwidth guaranteed to be served sub-second at each region. Traffic exceeding this rate will be considered burst.
              </p>
            </PopoverContent>
          </Popover>
        </div>
